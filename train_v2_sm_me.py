...
try:
    ...
    from src.model_v2_sm_me import ProteinModel
except:
    from data_loader import get_dataloader
    from model_v2_sm_me import ProteinModel
...
def train_model(model, train_loader, validation_loader, test_loader , plot=False, data_name = 'HUMAN',model_name='model'):   
    ...
    num_epochs = 100
    early_stopper = EarlyStopper(patience=100, min_delta=1) 
